#' @name core_2d_platformer
#' @rdname core_2d_platformer
#' @family Core examples
#' @title 2D camera platformer
#'
#' @description
...
#'
#' Example contributed for `raylib` library by arvyy (@arvyy) and reviewed by
#' Ramon Santamaria (@raysan5)
#'
#' Copyright (c) 2019 arvyy (@arvyy)
#'
#' Example modified for `raylib.R`
#'
